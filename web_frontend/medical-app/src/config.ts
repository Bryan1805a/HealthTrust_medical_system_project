...
export const NETWORK = "testnet"; // Set to testnet

// IDs for Medical System v3 on testnet (includes AdminCap to mint DoctorCap)
...
export const MODULE_NAME = "core"; // Name of the module in the Move file
